    ...
    for batch_i, batch in enumerate(loader):
        ...
        try:
            ...
            with autocast(enabled=fp16):
                ...
                loss_pre, loss_data_pre, n_correct_pre, n_token_pre = cal_ce_loss(pred_pre, gold_pre, eps*0.5)
        ...
        total_loss += loss_data_pre; n_token_total += n_token_pre;  n_token_correct += n_correct_pre
    ...
    with torch.no_grad():
        for batch_i, batch in enumerate(loader):
            ...
            with autocast(enabled=fp16):
                ...
                gold_pos, tgt_pos = tgt_pos[:, 1:], tgt_pos[:, :-1]
                pred_pre, pred_pos = model(src_seq, src_mask, tgt_pre, tgt_pos)[0:2]
                loss, loss_data, n_correct, n_token = cal_ce_loss(pred_pre, gold_pre)
