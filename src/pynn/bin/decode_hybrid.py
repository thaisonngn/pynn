...
from pynn.decoder.hybrid import beam_search
...
parser.add_argument('--s2s-scale', help='language model scale', type=float, default=1.0)
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        while True:
            ...
            hypos = beam_search(model, src, mask, device, args.s2s_scale,
                                lm, args.lm_scale, args.beam_size, args.pruning, args.blank)
